class footer extends HTMLElement {
    connectedCallback() {
        this.innerHTML = `
            <footer class="bg-gradient-to-r from-blue-500 to-black shadow-sm">
        <div class="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
            <span class="text-sm text-white sm:text-center">
                © 2025 A Rua Ensina™. Todos os direitos reservados.
            </span>
            <ul class="flex items-center space-x-4 mt-3 sm:mt-0">
                <li>
                    <a href="mailto: aruaensinaespro25@gmail.com">
                ...
                <li>
                    <a href="https://maps.app.goo.gl/NhuEk5y1S5JX7c8j9" target="_blank" rel="noopener noreferrer">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-6 h-6 text-white">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <li>
                    <a href="https://www.instagram.com/Institutoare/" target="_blank" rel="noopener noreferrer">
    ...
    <div class="bg-yellow-500 p-2"></div>
        `;
    }
}
